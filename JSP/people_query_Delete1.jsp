...
//------
	...
	try{
		...
		String A = "DELETE register, statuspeople FROM register INNER JOIN statuspeople ON register.people_peopleno = statuspeople.people_peopleno WHERE register.people_peopleno = ?";
